...
timer changed). That's a real, verifiable mismatch — rule 3 of the contract
...
"code shipped + testing confirmed," and doesn't say what to do when the
...
process. The agent had no explicit signal telling it "check for this
